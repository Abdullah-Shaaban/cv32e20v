...
extern int64_t matrix1[] __attribute__((aligned(4)));
extern int64_t matrix2[] __attribute__((aligned(4)));
extern int64_t golden_o[] __attribute__((aligned(4)));
extern int64_t output[] __attribute__((aligned(4)));
...
int main() {
  ...
  // Check the result
  int error = 0;
  for (uint32_t indx = 0; indx < AVL*AVL; indx++) {
